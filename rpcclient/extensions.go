...
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := hdfjson.NewDebugLevelCmd(levelSpec)
...
func (c *Client) CreateEncryptedWalletAsync(passphrase string) FutureCreateEncryptedWalletResult {
	cmd := hdfjson.NewCreateEncryptedWalletCmd(passphrase)
	return c.sendCmd(cmd)
}
...
func (r FutureListAddressTransactionsResult) Receive() ([]hdfjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
//
// NOTE: This is a hdfd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []hdfutil.Address, account string) FutureListAddressTransactionsResult {
	// Convert addresses to strings.
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.EncodeAddress())
	}
	cmd := hdfjson.NewListAddressTransactionsCmd(addrs, &account)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a hdfwallet extension.
func (c *Client) ListAddressTransactions(addresses []hdfutil.Address, account string) ([]hdfjson.ListTransactionsResult, error) {
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int32, error) {
	...
	var bestBlock hdfjson.GetBestBlockResult
...
func (c *Client) GetBestBlockAsync() FutureGetBestBlockResult {
	cmd := hdfjson.NewGetBestBlockCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := hdfjson.NewGetCurrentNetCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) GetHeadersAsync(blockLocators []chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := hdfjson.NewGetHeadersCmd(locators, hash)
	return c.sendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := hdfjson.NewExportWatchingWalletCmd(&account, hdfjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*hdfjson.SessionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session hdfjson.SessionResult
...
//
// NOTE: This is a ifishnet extension.
...
//
// NOTE: This is a ifishnet extension.
func (c *Client) Session() (*hdfjson.SessionResult, error) {
...
// NOTE: This is a ifishnet extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureVersionResult) Receive() (map[string]hdfjson.VersionResult,
	error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	...
	var vr map[string]hdfjson.VersionResult
...
// NOTE: This is a ifishnet extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) Version() (map[string]hdfjson.VersionResult, error) {
