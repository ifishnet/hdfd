...
func (c *Client) GetBestBlockHashAsync() FutureGetBestBlockHashResult {
	cmd := hdfjson.NewGetBestBlockHashCmd()
...
func (c *Client) legacyGetBlockRequest(hash string, verbose,
	...
	verboseJSON, err := json.Marshal(hdfjson.Bool(verbose))
	if err != nil {
		return nil, err
	}
	verboseTxJSON, err := json.Marshal(hdfjson.Bool(verboseTx))
	if err != nil {
		return nil, err
	}
...
func (c *Client) waitForGetBlockRes(respChan chan *response, hash string,
	...
	// communicating with a hdfd node which only understands the legacy
	// request, so we'll try that.
	if err, ok := err.(*hdfjson.RPCError); ok &&
		err.Code == hdfjson.ErrRPCInvalidParams.Code {
...
func (c *Client) GetBlockAsync(blockHash *chainhash.Hash) FutureGetBlockResult {
	...
	cmd := hdfjson.NewGetBlockCmd(hash, hdfjson.Int(0))
...
func (r FutureGetBlockVerboseResult) Receive() (*hdfjson.GetBlockVerboseResult, error) {
	...
	var blockResult hdfjson.GetBlockVerboseResult
...
func (c *Client) GetBlockVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseResult {
	...
	cmd := hdfjson.NewGetBlockCmd(hash, hdfjson.Int(1))
...
func (c *Client) GetBlockVerbose(blockHash *chainhash.Hash) (*hdfjson.GetBlockVerboseResult, error) {
...
func (r FutureGetBlockVerboseTxResult) Receive() (*hdfjson.GetBlockVerboseTxResult, error) {
	res, err := r.client.waitForGetBlockRes(r.Response, r.hash, true, true)
	if err != nil {
		return nil, err
	}

	var blockResult hdfjson.GetBlockVerboseTxResult
	err = json.Unmarshal(res, &blockResult)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetBlockVerboseTxAsync(blockHash *chainhash.Hash) FutureGetBlockVerboseTxResult {
	...
	cmd := hdfjson.NewGetBlockCmd(hash, hdfjson.Int(2))
...
// See GetBlock to retrieve a raw block instead.
func (c *Client) GetBlockVerboseTx(blockHash *chainhash.Hash) (*hdfjson.GetBlockVerboseTxResult, error) {
...
func (c *Client) GetBlockCountAsync() FutureGetBlockCountResult {
	cmd := hdfjson.NewGetBlockCountCmd()
	return c.sendCmd(cmd)
}
...
func (r FutureGetChainTxStatsResult) Receive() (*hdfjson.GetChainTxStatsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var chainTxStats hdfjson.GetChainTxStatsResult
...
func (c *Client) GetChainTxStatsAsync() FutureGetChainTxStatsResult {
	cmd := hdfjson.NewGetChainTxStatsCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetChainTxStatsNBlocksAsync(nBlocks int32) FutureGetChainTxStatsResult {
	cmd := hdfjson.NewGetChainTxStatsCmd(&nBlocks, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetChainTxStatsNBlocksBlockHashAsync(nBlocks int32, blockHash chainhash.Hash) FutureGetChainTxStatsResult {
	hash := blockHash.String()
	cmd := hdfjson.NewGetChainTxStatsCmd(&nBlocks, &hash)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetChainTxStats() (*hdfjson.GetChainTxStatsResult, error) {
...
func (c *Client) GetChainTxStatsNBlocks(nBlocks int32) (*hdfjson.GetChainTxStatsResult, error) {
...
func (c *Client) GetChainTxStatsNBlocksBlockHash(nBlocks int32, blockHash chainhash.Hash) (*hdfjson.GetChainTxStatsResult, error) {
...
func (c *Client) GetDifficultyAsync() FutureGetDifficultyResult {
	cmd := hdfjson.NewGetDifficultyCmd()
	return c.sendCmd(cmd)
}
...
func unmarshalPartialGetBlockChainInfoResult(res []byte) (*hdfjson.GetBlockChainInfoResult, error) {
	var chainInfo hdfjson.GetBlockChainInfoResult
...
func unmarshalGetBlockChainInfoResultSoftForks(chainInfo *hdfjson.GetBlockChainInfoResult,
	version BackendVersion, res []byte) error {

	switch version {
	// Versions of bitcoind on or after v0.19.0 use the unified format.
	case BitcoindPost19:
		var softForks hdfjson.UnifiedSoftForks
	...
	default:
		var softForks hdfjson.SoftForks
		if err := json.Unmarshal(res, &softForks); err != nil {
			return err
		}
...
func (r FutureGetBlockChainInfoResult) Receive() (*hdfjson.GetBlockChainInfoResult, error) {
...
func (c *Client) GetBlockChainInfoAsync() FutureGetBlockChainInfoResult {
	cmd := hdfjson.NewGetBlockChainInfoCmd()
...
// of the main chain.
func (c *Client) GetBlockChainInfo() (*hdfjson.GetBlockChainInfoResult, error) {
...
func (c *Client) GetBlockHashAsync(blockHeight int64) FutureGetBlockHashResult {
	cmd := hdfjson.NewGetBlockHashCmd(blockHeight)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderResult {
	...
	cmd := hdfjson.NewGetBlockHeaderCmd(hash, hdfjson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockHeaderVerboseResult) Receive() (*hdfjson.GetBlockHeaderVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a string.
	var bh hdfjson.GetBlockHeaderVerboseResult
...
func (c *Client) GetBlockHeaderVerboseAsync(blockHash *chainhash.Hash) FutureGetBlockHeaderVerboseResult {
	...
	cmd := hdfjson.NewGetBlockHeaderCmd(hash, hdfjson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockHeaderVerbose(blockHash *chainhash.Hash) (*hdfjson.GetBlockHeaderVerboseResult, error) {
...
// its hash.
func (r FutureGetMempoolEntryResult) Receive() (*hdfjson.GetMempoolEntryResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var mempoolEntryResult hdfjson.GetMempoolEntryResult
...
func (c *Client) GetMempoolEntryAsync(txHash string) FutureGetMempoolEntryResult {
	cmd := hdfjson.NewGetMempoolEntryCmd(txHash)
	return c.sendCmd(cmd)
}

// GetMempoolEntry returns a data structure with information about the
// transaction in the memory pool given its hash.
func (c *Client) GetMempoolEntry(txHash string) (*hdfjson.GetMempoolEntryResult, error) {
...
func (c *Client) GetRawMempoolAsync() FutureGetRawMempoolResult {
	cmd := hdfjson.NewGetRawMempoolCmd(hdfjson.Bool(false))
	return c.sendCmd(cmd)
}
...
func (r FutureGetRawMempoolVerboseResult) Receive() (map[string]hdfjson.GetRawMempoolVerboseResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// results.
	var mempoolItems map[string]hdfjson.GetRawMempoolVerboseResult
...
func (c *Client) GetRawMempoolVerboseAsync() FutureGetRawMempoolVerboseResult {
	cmd := hdfjson.NewGetRawMempoolCmd(hdfjson.Bool(true))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawMempoolVerbose() (map[string]hdfjson.GetRawMempoolVerboseResult, error) {
...
func (c *Client) EstimateFeeAsync(numBlocks int64) FutureEstimateFeeResult {
	cmd := hdfjson.NewEstimateFeeCmd(numBlocks)
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// estimated fee.
func (r FutureEstimateSmartFeeResult) Receive() (*hdfjson.EstimateSmartFeeResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var verified hdfjson.EstimateSmartFeeResult
...
func (c *Client) EstimateSmartFeeAsync(confTarget int64, mode *hdfjson.EstimateSmartFeeMode) FutureEstimateSmartFeeResult {
	cmd := hdfjson.NewEstimateSmartFeeCmd(confTarget, mode)
	return c.sendCmd(cmd)
}

// EstimateSmartFee requests the server to estimate a fee level based on the given parameters.
func (c *Client) EstimateSmartFee(confTarget int64, mode *hdfjson.EstimateSmartFeeMode) (*hdfjson.EstimateSmartFeeResult, error) {
...
func (c *Client) VerifyChainAsync() FutureVerifyChainResult {
	cmd := hdfjson.NewVerifyChainCmd(nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainLevelAsync(checkLevel int32) FutureVerifyChainResult {
	cmd := hdfjson.NewVerifyChainCmd(&checkLevel, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) VerifyChainBlocksAsync(checkLevel, numBlocks int32) FutureVerifyChainResult {
	cmd := hdfjson.NewVerifyChainCmd(&checkLevel, &numBlocks)
	return c.sendCmd(cmd)
}
...
func (r FutureGetTxOutResult) Receive() (*hdfjson.GetTxOutResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var txOutInfo *hdfjson.GetTxOutResult
...
func (c *Client) GetTxOutAsync(txHash *chainhash.Hash, index uint32, mempool bool) FutureGetTxOutResult {
	...
	cmd := hdfjson.NewGetTxOutCmd(hash, index, &mempool)
	return c.sendCmd(cmd)
}

// GetTxOut returns the transaction output info if it's unspent and
// nil, otherwise.
func (c *Client) GetTxOut(txHash *chainhash.Hash, index uint32, mempool bool) (*hdfjson.GetTxOutResult, error) {
...
// NOTE: This is a ifishnet extension ported from
// github.com/decred/dcrrpcclient.
func (r FutureRescanBlocksResult) Receive() ([]hdfjson.RescannedBlock, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var rescanBlocksResult []hdfjson.RescannedBlock
...
func (c *Client) RescanBlocksAsync(blockHashes []chainhash.Hash) FutureRescanBlocksResult {
	...
	cmd := hdfjson.NewRescanBlocksCmd(strBlockHashes)
	return c.sendCmd(cmd)
}
...
// NOTE: This is a ifishnet extension ported from
// github.com/decred/dcrrpcclient.
func (c *Client) RescanBlocks(blockHashes []chainhash.Hash) ([]hdfjson.RescannedBlock, error) {
...
func (c *Client) InvalidateBlockAsync(blockHash *chainhash.Hash) FutureInvalidateBlockResult {
	...
	cmd := hdfjson.NewInvalidateBlockCmd(hash)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCFilterAsync(blockHash *chainhash.Hash,
	...
	cmd := hdfjson.NewGetCFilterCmd(hash, filterType)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetCFilterHeaderAsync(blockHash *chainhash.Hash,
	...
	cmd := hdfjson.NewGetCFilterHeaderCmd(hash, filterType)
	return c.sendCmd(cmd)
}
...
func (r FutureGetBlockStatsResult) Receive() (*hdfjson.GetBlockStatsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var blockStats hdfjson.GetBlockStatsResult
...
func (c *Client) GetBlockStatsAsync(hashOrHeight interface{}, stats *[]string) FutureGetBlockStatsResult {
	...
	cmd := hdfjson.NewGetBlockStatsCmd(hdfjson.HashOrHeight{Value: hashOrHeight}, stats)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBlockStats(hashOrHeight interface{}, stats *[]string) (*hdfjson.GetBlockStatsResult, error) {
