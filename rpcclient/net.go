...
func (c *Client) AddNodeAsync(host string, command AddNodeCommand) FutureAddNodeResult {
	cmd := hdfjson.NewAddNodeCmd(host, hdfjson.AddNodeSubCmd(command))
...
func (c *Client) NodeAsync(command hdfjson.NodeSubCmd, host string,
	connectSubCmd *string) FutureNodeResult {
	cmd := hdfjson.NewNodeCmd(command, host, connectSubCmd)
	return c.sendCmd(cmd)
}
...
func (c *Client) Node(command hdfjson.NodeSubCmd, host string,
...
func (r FutureGetAddedNodeInfoResult) Receive() ([]hdfjson.GetAddedNodeInfoResult, error) {
	...
	var nodeInfo []hdfjson.GetAddedNodeInfoResult
...
func (c *Client) GetAddedNodeInfoAsync(peer string) FutureGetAddedNodeInfoResult {
	cmd := hdfjson.NewGetAddedNodeInfoCmd(true, &peer)
	return c.sendCmd(cmd)
}
...
// peers.
func (c *Client) GetAddedNodeInfo(peer string) ([]hdfjson.GetAddedNodeInfoResult, error) {
...
func (c *Client) GetAddedNodeInfoNoDNSAsync(peer string) FutureGetAddedNodeInfoNoDNSResult {
	cmd := hdfjson.NewGetAddedNodeInfoCmd(false, &peer)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetConnectionCountAsync() FutureGetConnectionCountResult {
	cmd := hdfjson.NewGetConnectionCountCmd()
	return c.sendCmd(cmd)
}
...
// the current network.
func (r FutureGetNetworkInfoResult) Receive() (*hdfjson.GetNetworkInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var networkInfo hdfjson.GetNetworkInfoResult
...
func (c *Client) GetNetworkInfoAsync() FutureGetNetworkInfoResult {
	cmd := hdfjson.NewGetNetworkInfoCmd()
	return c.sendCmd(cmd)
}

// GetNetworkInfo returns data about the current network.
func (c *Client) GetNetworkInfo() (*hdfjson.GetNetworkInfoResult, error) {
...
func (r FutureGetPeerInfoResult) Receive() ([]hdfjson.GetPeerInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as an array of getpeerinfo result objects.
	var peerInfo []hdfjson.GetPeerInfoResult
...
func (c *Client) GetPeerInfoAsync() FutureGetPeerInfoResult {
	cmd := hdfjson.NewGetPeerInfoCmd()
	return c.sendCmd(cmd)
}

// GetPeerInfo returns data about each connected network peer.
func (c *Client) GetPeerInfo() ([]hdfjson.GetPeerInfoResult, error) {
...
// traffic statistics.
func (r FutureGetNetTotalsResult) Receive() (*hdfjson.GetNetTotalsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var totals hdfjson.GetNetTotalsResult
...
func (c *Client) GetNetTotalsAsync() FutureGetNetTotalsResult {
	cmd := hdfjson.NewGetNetTotalsCmd()
	return c.sendCmd(cmd)
}

// GetNetTotals returns network traffic statistics.
func (c *Client) GetNetTotals() (*hdfjson.GetNetTotalsResult, error) {
