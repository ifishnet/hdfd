...
func (r FutureGetTransactionResult) Receive() (*hdfjson.GetTransactionResult, error) {
	...
	var getTx hdfjson.GetTransactionResult
...
func (c *Client) GetTransactionAsync(txHash *chainhash.Hash) FutureGetTransactionResult {
	...
	cmd := hdfjson.NewGetTransactionCmd(hash, nil)
...
func (c *Client) GetTransaction(txHash *chainhash.Hash) (*hdfjson.GetTransactionResult, error) {
...
func (c *Client) GetTransactionWatchOnlyAsync(txHash *chainhash.Hash, watchOnly bool) FutureGetTransactionResult {
	...
	cmd := hdfjson.NewGetTransactionCmd(hash, &watchOnly)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetTransactionWatchOnly(txHash *chainhash.Hash, watchOnly bool) (*hdfjson.GetTransactionResult, error) {
...
func (r FutureListTransactionsResult) Receive() ([]hdfjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var transactions []hdfjson.ListTransactionsResult
...
func (c *Client) ListTransactionsAsync(account string) FutureListTransactionsResult {
	cmd := hdfjson.NewListTransactionsCmd(&account, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactions(account string) ([]hdfjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountAsync(account string, count int) FutureListTransactionsResult {
	cmd := hdfjson.NewListTransactionsCmd(&account, &count, nil, nil)
	return c.sendCmd(cmd)
}
...
// different options.
func (c *Client) ListTransactionsCount(account string, count int) ([]hdfjson.ListTransactionsResult, error) {
...
func (c *Client) ListTransactionsCountFromAsync(account string, count, from int) FutureListTransactionsResult {
	cmd := hdfjson.NewListTransactionsCmd(&account, &count, &from, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListTransactionsCountFrom(account string, count, from int) ([]hdfjson.ListTransactionsResult, error) {
...
func (r FutureListUnspentResult) Receive() ([]hdfjson.ListUnspentResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var unspent []hdfjson.ListUnspentResult
...
func (c *Client) ListUnspentAsync() FutureListUnspentResult {
	cmd := hdfjson.NewListUnspentCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinAsync(minConf int) FutureListUnspentResult {
	cmd := hdfjson.NewListUnspentCmd(&minConf, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAsync(minConf, maxConf int) FutureListUnspentResult {
	cmd := hdfjson.NewListUnspentCmd(&minConf, &maxConf, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []hdfutil.Address) FutureListUnspentResult {
	addrStrs := make([]string, 0, len(addrs))
	for _, a := range addrs {
		addrStrs = append(addrStrs, a.EncodeAddress())
	}

	cmd := hdfjson.NewListUnspentCmd(&minConf, &maxConf, &addrStrs)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListUnspent() ([]hdfjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMin(minConf int) ([]hdfjson.ListUnspentResult, error) {
...
// a filter.
func (c *Client) ListUnspentMinMax(minConf, maxConf int) ([]hdfjson.ListUnspentResult, error) {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []hdfutil.Address) ([]hdfjson.ListUnspentResult, error) {
...
func (r FutureListSinceBlockResult) Receive() (*hdfjson.ListSinceBlockResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var listResult hdfjson.ListSinceBlockResult
...
func (c *Client) ListSinceBlockAsync(blockHash *chainhash.Hash) FutureListSinceBlockResult {
	var hash *string
	if blockHash != nil {
		hash = hdfjson.String(blockHash.String())
	}

	cmd := hdfjson.NewListSinceBlockCmd(hash, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlock(blockHash *chainhash.Hash) (*hdfjson.ListSinceBlockResult, error) {
...
func (c *Client) ListSinceBlockMinConfAsync(blockHash *chainhash.Hash, minConfirms int) FutureListSinceBlockResult {
	...
	cmd := hdfjson.NewListSinceBlockCmd(hash, &minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListSinceBlockMinConf(blockHash *chainhash.Hash, minConfirms int) (*hdfjson.ListSinceBlockResult, error) {
...
func (c *Client) LockUnspentAsync(unlock bool, ops []*wire.OutPoint) FutureLockUnspentResult {
	outputs := make([]hdfjson.TransactionInput, len(ops))
	for i, op := range ops {
		outputs[i] = hdfjson.TransactionInput{
			Txid: op.Hash.String(),
			Vout: op.Index,
		}
	}
	cmd := hdfjson.NewLockUnspentCmd(unlock, outputs)
	return c.sendCmd(cmd)
}
...
func (r FutureListLockUnspentResult) Receive() ([]*wire.OutPoint, error) {
	...
	var inputs []hdfjson.TransactionInput
...
func (c *Client) ListLockUnspentAsync() FutureListLockUnspentResult {
	cmd := hdfjson.NewListLockUnspentCmd()
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTxFeeAsync(fee hdfutil.Amount) FutureSetTxFeeResult {
	cmd := hdfjson.NewSetTxFeeCmd(fee.ToHDF())
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTxFee(fee hdfutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address hdfutil.Address, amount hdfutil.Amount) FutureSendToAddressResult {
	addr := address.EncodeAddress()
	cmd := hdfjson.NewSendToAddressCmd(addr, amount.ToHDF(), nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendToAddress(address hdfutil.Address, amount hdfutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address hdfutil.Address,
	amount hdfutil.Amount, comment,
	commentTo string) FutureSendToAddressResult {

	addr := address.EncodeAddress()
	cmd := hdfjson.NewSendToAddressCmd(addr, amount.ToHDF(), &comment,
		&commentTo)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address hdfutil.Address, amount hdfutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress hdfutil.Address, amount hdfutil.Amount) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := hdfjson.NewSendFromCmd(fromAccount, addr, amount.ToHDF(), nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress hdfutil.Address, amount hdfutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress hdfutil.Address, amount hdfutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
	cmd := hdfjson.NewSendFromCmd(fromAccount, addr, amount.ToHDF(),
		&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress hdfutil.Address, amount hdfutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress hdfutil.Address, amount hdfutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress hdfutil.Address,
	amount hdfutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[hdfutil.Address]hdfutil.Amount) FutureSendManyResult {
	convertedAmounts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmounts[addr.EncodeAddress()] = amount.ToHDF()
	}
	cmd := hdfjson.NewSendManyCmd(fromAccount, convertedAmounts, nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[hdfutil.Address]hdfutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[hdfutil.Address]hdfutil.Amount,
	...
	cmd := hdfjson.NewSendManyCmd(fromAccount, convertedAmounts,
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[hdfutil.Address]hdfutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (hdfutil.Address, error) {
	...
	return hdfutil.DecodeAddress(addr, r.network)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []hdfutil.Address, account string) FutureAddMultisigAddressResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := hdfjson.NewAddMultisigAddressCmd(requiredSigs, addrs, &account)
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []hdfutil.Address, account string) (hdfutil.Address, error) {
...
func (r FutureCreateMultisigResult) Receive() (*hdfjson.CreateMultiSigResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var multisigRes hdfjson.CreateMultiSigResult
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []hdfutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}

	cmd := hdfjson.NewCreateMultisigCmd(requiredSigs, addrs)
	return c.sendCmd(cmd)
}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []hdfutil.Address) (*hdfjson.CreateMultiSigResult, error) {
...
func (c *Client) CreateNewAccountAsync(account string) FutureCreateNewAccountResult {
	cmd := hdfjson.NewCreateNewAccountCmd(account)
	return c.sendCmd(cmd)
}
...
// address.
func (r FutureGetNewAddressResult) Receive() (hdfutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddressAsync(account string) FutureGetNewAddressResult {
	cmd := hdfjson.NewGetNewAddressCmd(&account)
...
// chain params.
func (c *Client) GetNewAddress(account string) (hdfutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (hdfutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddressAsync(account string) FutureGetRawChangeAddressResult {
	cmd := hdfjson.NewGetRawChangeAddressCmd(&account)
...
func (c *Client) GetRawChangeAddress(account string) (hdfutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (hdfutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddressAsync(address string) FutureAddWitnessAddressResult {
	cmd := hdfjson.NewAddWitnessAddressCmd(address)
...
func (c *Client) AddWitnessAddress(address string) (hdfutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (hdfutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddressAsync(account string) FutureGetAccountAddressResult {
	cmd := hdfjson.NewGetAccountAddressCmd(account)
...
func (c *Client) GetAccountAddress(account string) (hdfutil.Address, error) {
...
func (c *Client) GetAccountAsync(address hdfutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
	cmd := hdfjson.NewGetAccountCmd(addr)
	return c.sendCmd(cmd)
}

// GetAccount returns the account associated with the passed address.
func (c *Client) GetAccount(address hdfutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address hdfutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
	cmd := hdfjson.NewSetAccountCmd(addr, account)
	return c.sendCmd(cmd)
}

// SetAccount sets the account associated with the passed address.
func (c *Client) SetAccount(address hdfutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]hdfutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
	...
	addresses := make([]hdfutil.Address, len(addrStrings))
	for i, addrString := range addrStrings {
		addresses[i], err = hdfutil.DecodeAddress(addrString, r.network)
		if err != nil {
			return nil, err
		}
	}
...
func (c *Client) GetAddressesByAccountAsync(account string) FutureGetAddressesByAccountResult {
	cmd := hdfjson.NewGetAddressesByAccountCmd(account)
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]hdfutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount hdfutil.Amount) FutureMoveResult {
	cmd := hdfjson.NewMoveCmd(fromAccount, toAccount, amount.ToHDF(), nil,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) Move(fromAccount, toAccount string, amount hdfutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount hdfutil.Amount, minConfirms int) FutureMoveResult {

	cmd := hdfjson.NewMoveCmd(fromAccount, toAccount, amount.ToHDF(),
		&minConfirms, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount hdfutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount hdfutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount hdfutil.Amount,
...
func (c *Client) RenameAccountAsync(oldAccount, newAccount string) FutureRenameAccountResult {
	cmd := hdfjson.NewRenameAccountCmd(oldAccount, newAccount)
	return c.sendCmd(cmd)
}
...
func (r FutureValidateAddressResult) Receive() (*hdfjson.ValidateAddressWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var addrResult hdfjson.ValidateAddressWalletResult
...
func (c *Client) ValidateAddressAsync(address hdfutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
	cmd := hdfjson.NewValidateAddressCmd(addr)
	return c.sendCmd(cmd)
}

// ValidateAddress returns information about the given bitcoin address.
func (c *Client) ValidateAddress(address hdfutil.Address) (*hdfjson.ValidateAddressWalletResult, error) {
...
func (c *Client) KeyPoolRefillAsync() FutureKeyPoolRefillResult {
	cmd := hdfjson.NewKeyPoolRefillCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) KeyPoolRefillSizeAsync(newSize uint) FutureKeyPoolRefillResult {
	cmd := hdfjson.NewKeyPoolRefillCmd(&newSize)
	return c.sendCmd(cmd)
}
...
func (r FutureListAccountsResult) Receive() (map[string]hdfutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]hdfutil.Amount)
	for k, v := range accounts {
		amount, err := hdfutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccountsAsync() FutureListAccountsResult {
	cmd := hdfjson.NewListAccountsCmd(nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccounts() (map[string]hdfutil.Amount, error) {
...
func (c *Client) ListAccountsMinConfAsync(minConfirms int) FutureListAccountsResult {
	cmd := hdfjson.NewListAccountsCmd(&minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]hdfutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (hdfutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := hdfutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (hdfutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalanceAsync(account string) FutureGetBalanceResult {
	cmd := hdfjson.NewGetBalanceCmd(&account, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalance(account string) (hdfutil.Amount, error) {
...
func (c *Client) GetBalanceMinConfAsync(account string, minConfirms int) FutureGetBalanceResult {
	cmd := hdfjson.NewGetBalanceCmd(&account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (hdfutil.Amount, error) {
...
func (r FutureGetBalancesResult) Receive() (*hdfjson.GetBalancesResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a floating point number.
	var balances hdfjson.GetBalancesResult
...
func (c *Client) GetBalancesAsync() FutureGetBalancesResult {
	cmd := hdfjson.NewGetBalancesCmd()
	return c.sendCmd(cmd)
}

// GetBalances returns the available balances from the server.
func (c *Client) GetBalances() (*hdfjson.GetBalancesResult, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (hdfutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAccountAsync(account string) FutureGetReceivedByAccountResult {
	cmd := hdfjson.NewGetReceivedByAccountCmd(account, nil)
	return c.sendCmd(cmd)
}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (hdfutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConfAsync(account string, minConfirms int) FutureGetReceivedByAccountResult {
	cmd := hdfjson.NewGetReceivedByAccountCmd(account, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (hdfutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (hdfutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalanceAsync(account string) FutureGetUnconfirmedBalanceResult {
	cmd := hdfjson.NewGetUnconfirmedBalanceCmd(&account)
	return c.sendCmd(cmd)
}

// GetUnconfirmedBalance returns the unconfirmed balance from the server for
// the specified account.
func (c *Client) GetUnconfirmedBalance(account string) (hdfutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (hdfutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address hdfutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := hdfjson.NewGetReceivedByAddressCmd(addr, nil)
	return c.sendCmd(cmd)
...
// confirmations.
func (c *Client) GetReceivedByAddress(address hdfutil.Address) (hdfutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address hdfutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
	cmd := hdfjson.NewGetReceivedByAddressCmd(addr, &minConfirms)
	return c.sendCmd(cmd)
}
...
func (c *Client) GetReceivedByAddressMinConf(address hdfutil.Address, minConfirms int) (hdfutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by account.
func (r FutureListReceivedByAccountResult) Receive() ([]hdfjson.ListReceivedByAccountResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []hdfjson.ListReceivedByAccountResult
...
func (c *Client) ListReceivedByAccountAsync() FutureListReceivedByAccountResult {
	cmd := hdfjson.NewListReceivedByAccountCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccount() ([]hdfjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountMinConfAsync(minConfirms int) FutureListReceivedByAccountResult {
	cmd := hdfjson.NewListReceivedByAccountCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountMinConf(minConfirms int) ([]hdfjson.ListReceivedByAccountResult, error) {
...
func (c *Client) ListReceivedByAccountIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAccountResult {
	cmd := hdfjson.NewListReceivedByAccountCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAccountIncludeEmpty(minConfirms int, includeEmpty bool) ([]hdfjson.ListReceivedByAccountResult, error) {
...
// Receive waits for the response promised by the future and returns a list of
// balances by address.
func (r FutureListReceivedByAddressResult) Receive() ([]hdfjson.ListReceivedByAddressResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var received []hdfjson.ListReceivedByAddressResult
	err = json.Unmarshal(res, &received)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListReceivedByAddressAsync() FutureListReceivedByAddressResult {
	cmd := hdfjson.NewListReceivedByAddressCmd(nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddress() ([]hdfjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressMinConfAsync(minConfirms int) FutureListReceivedByAddressResult {
	cmd := hdfjson.NewListReceivedByAddressCmd(&minConfirms, nil, nil)
	return c.sendCmd(cmd)
}
...
// received any payments in the results.
func (c *Client) ListReceivedByAddressMinConf(minConfirms int) ([]hdfjson.ListReceivedByAddressResult, error) {
...
func (c *Client) ListReceivedByAddressIncludeEmptyAsync(minConfirms int, includeEmpty bool) FutureListReceivedByAddressResult {
	cmd := hdfjson.NewListReceivedByAddressCmd(&minConfirms, &includeEmpty,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ListReceivedByAddressIncludeEmpty(minConfirms int, includeEmpty bool) ([]hdfjson.ListReceivedByAddressResult, error) {
...
func (c *Client) WalletPassphrase(passphrase string, timeoutSecs int64) error {
	cmd := hdfjson.NewWalletPassphraseCmd(passphrase, timeoutSecs)
...
func (c *Client) WalletPassphraseChangeAsync(old, new string) FutureWalletPassphraseChangeResult {
	cmd := hdfjson.NewWalletPassphraseChangeCmd(old, new)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignMessageAsync(address hdfutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
	cmd := hdfjson.NewSignMessageCmd(addr, message)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address hdfutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address hdfutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
	cmd := hdfjson.NewVerifyMessageCmd(addr, signature, message)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address hdfutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*hdfutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return hdfutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address hdfutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
	cmd := hdfjson.NewDumpPrivKeyCmd(addr)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address hdfutil.Address) (*hdfutil.WIF, error) {
...
func (c *Client) ImportAddressAsync(address string) FutureImportAddressResult {
	cmd := hdfjson.NewImportAddressCmd(address, "", nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportAddressRescanAsync(address string, account string, rescan bool) FutureImportAddressResult {
	cmd := hdfjson.NewImportAddressCmd(address, account, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *hdfutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := hdfjson.NewImportPrivKeyCmd(wif, nil, nil)
	return c.sendCmd(cmd)
}

// ImportPrivKey imports the passed private key which must be the wallet import
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *hdfutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *hdfutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := hdfjson.NewImportPrivKeyCmd(wif, &label, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *hdfutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *hdfutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}

	cmd := hdfjson.NewImportPrivKeyCmd(wif, &label, &rescan)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *hdfutil.WIF, label string, rescan bool) error {
...
func (c *Client) ImportPubKeyAsync(pubKey string) FutureImportPubKeyResult {
	cmd := hdfjson.NewImportPubKeyCmd(pubKey, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) ImportPubKeyRescanAsync(pubKey string, rescan bool) FutureImportPubKeyResult {
	cmd := hdfjson.NewImportPubKeyCmd(pubKey, &rescan)
	return c.sendCmd(cmd)
}
...
func (r FutureGetInfoResult) Receive() (*hdfjson.InfoWalletResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var infoRes hdfjson.InfoWalletResult
...
func (c *Client) GetInfo() (*hdfjson.InfoWalletResult, error) {
...
// getwalletinfo (NYI in hdfwallet or hdfjson)
