...
const (
	...
	defaultMaxFeeRate = hdfutil.SatoshiPerBitcoin / 10
)
...
func (r FutureGetRawTransactionResult) Receive() (*hdfutil.Tx, error) {
	...
	return hdfutil.NewTx(&msgTx), nil
}
...
func (c *Client) GetRawTransactionAsync(txHash *chainhash.Hash) FutureGetRawTransactionResult {
	...
	cmd := hdfjson.NewGetRawTransactionCmd(hash, hdfjson.Int(0))
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*hdfutil.Tx, error) {
...
func (r FutureGetRawTransactionVerboseResult) Receive() (*hdfjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var rawTxResult hdfjson.TxRawResult
...
func (c *Client) GetRawTransactionVerboseAsync(txHash *chainhash.Hash) FutureGetRawTransactionVerboseResult {
	...
	cmd := hdfjson.NewGetRawTransactionCmd(hash, hdfjson.Int(1))
	return c.sendCmd(cmd)
}
...
func (c *Client) GetRawTransactionVerbose(txHash *chainhash.Hash) (*hdfjson.TxRawResult, error) {
...
func (r FutureDecodeRawTransactionResult) Receive() (*hdfjson.TxRawResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) DecodeRawTransactionAsync(serializedTx []byte) FutureDecodeRawTransactionResult {
	...
	cmd := hdfjson.NewDecodeRawTransactionCmd(txHex)
	return c.sendCmd(cmd)
}

// DecodeRawTransaction returns information about a transaction given its
// serialized bytes.
func (c *Client) DecodeRawTransaction(serializedTx []byte) (*hdfjson.TxRawResult, error) {
...
func (r FutureFundRawTransactionResult) Receive() (*hdfjson.FundRawTransactionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	var marshalled hdfjson.FundRawTransactionResult
...
func (c *Client) FundRawTransactionAsync(tx *wire.MsgTx, opts hdfjson.FundRawTransactionOpts, isWitness *bool) FutureFundRawTransactionResult {
	var txBuf bytes.Buffer
	if err := tx.Serialize(&txBuf); err != nil {
		return newFutureError(err)
	}

	cmd := hdfjson.NewFundRawTransactionCmd(txBuf.Bytes(), opts, isWitness)
	return c.sendCmd(cmd)
}

// FundRawTransaction returns the result of trying to fund the given transaction with
// funds from the node wallet
func (c *Client) FundRawTransaction(tx *wire.MsgTx, opts hdfjson.FundRawTransactionOpts, isWitness *bool) (*hdfjson.FundRawTransactionResult, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []hdfjson.TransactionInput,
	amounts map[hdfutil.Address]hdfutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {

	convertedAmts := make(map[string]float64, len(amounts))
	for addr, amount := range amounts {
		convertedAmts[addr.String()] = amount.ToHDF()
	}
	cmd := hdfjson.NewCreateRawTransactionCmd(inputs, convertedAmts, lockTime)
	return c.sendCmd(cmd)
}
...
func (c *Client) CreateRawTransaction(inputs []hdfjson.TransactionInput,
	amounts map[hdfutil.Address]hdfutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SendRawTransactionAsync(tx *wire.MsgTx, allowHighFees bool) FutureSendRawTransactionResult {
	...
	var cmd *hdfjson.SendRawTransactionCmd
	switch version {
	...
	case BitcoindPost19:
		...
		cmd = hdfjson.NewBitcoindSendRawTransactionCmd(txHex, maxFeeRate)

	// Otherwise, use the AllowHighFees field.
	default:
		cmd = hdfjson.NewSendRawTransactionCmd(txHex, &allowHighFees)
	}
...
func (r FutureSignRawTransactionResult) Receive() (*wire.MsgTx, bool, error) {
	...
	var signRawTxResult hdfjson.SignRawTransactionResult
...
func (c *Client) SignRawTransactionAsync(tx *wire.MsgTx) FutureSignRawTransactionResult {
	...
	cmd := hdfjson.NewSignRawTransactionCmd(txHex, nil, nil, nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction2Async(tx *wire.MsgTx, inputs []hdfjson.RawTxInput) FutureSignRawTransactionResult {
	txHex := ""
	if tx != nil {
		// Serialize the transaction and convert to hex string.
		buf := bytes.NewBuffer(make([]byte, 0, tx.SerializeSize()))
	...
	cmd := hdfjson.NewSignRawTransactionCmd(txHex, &inputs, nil, nil)
	return c.sendCmd(cmd)
}
...
// transactions.
func (c *Client) SignRawTransaction2(tx *wire.MsgTx, inputs []hdfjson.RawTxInput) (*wire.MsgTx, bool, error) {
...
func (c *Client) SignRawTransaction3Async(tx *wire.MsgTx,
	...
	cmd := hdfjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		nil)
	return c.sendCmd(cmd)
}
...
func (c *Client) SignRawTransaction4Async(tx *wire.MsgTx,
	inputs []hdfjson.RawTxInput, privKeysWIF []string,
	...
	cmd := hdfjson.NewSignRawTransactionCmd(txHex, &inputs, &privKeysWIF,
		hdfjson.String(string(hashType)))
	return c.sendCmd(cmd)
}
...
func (c *Client) SearchRawTransactionsAsync(address hdfutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
	addr := address.EncodeAddress()
	verbose := hdfjson.Int(0)
	cmd := hdfjson.NewSearchRawTransactionsCmd(addr, verbose, &skip, &count,
...
func (c *Client) SearchRawTransactions(address hdfutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
// Receive waits for the response promised by the future and returns the
// found raw transactions.
func (r FutureSearchRawTransactionsVerboseResult) Receive() ([]*hdfjson.SearchRawTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var result []*hdfjson.SearchRawTransactionsResult
...
func (c *Client) SearchRawTransactionsVerboseAsync(address hdfutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address hdfutil.Address, skip,
	count int, includePrevOut, reverse bool, filterAddrs []string) ([]*hdfjson.SearchRawTransactionsResult, error) {
...
func (r FutureDecodeScriptResult) Receive() (*hdfjson.DecodeScriptResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var decodeScriptResult hdfjson.DecodeScriptResult
...
func (c *Client) DecodeScriptAsync(serializedScript []byte) FutureDecodeScriptResult {
	...
	cmd := hdfjson.NewDecodeScriptCmd(scriptHex)
	return c.sendCmd(cmd)
}

// DecodeScript returns information about a script given its serialized bytes.
func (c *Client) DecodeScript(serializedScript []byte) (*hdfjson.DecodeScriptResult, error) {
