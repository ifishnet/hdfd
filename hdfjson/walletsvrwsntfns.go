...
const (
	...
	// HdfdConnectedNtfnMethod is the method used for notifications when
	// a wallet server is connected to a chain server.
	HdfdConnectedNtfnMethod = "hdfdconnected"
...
// HdfdConnectedNtfn defines the hdfdconnected JSON-RPC notification.
type HdfdConnectedNtfn struct {
	Connected bool
}

// NewHdfdConnectedNtfn returns a new instance which can be used to issue a
// hdfdconnected JSON-RPC notification.
func NewHdfdConnectedNtfn(connected bool) *HdfdConnectedNtfn {
	return &HdfdConnectedNtfn{
		Connected: connected,
	}
}
...
func init() {
	...
	MustRegisterCmd(HdfdConnectedNtfnMethod, (*HdfdConnectedNtfn)(nil), flags)
