...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/ifishnet/hdfd/peer)
...
```bash
$ go get -u github.com/ifishnet/hdfd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/ifishnet/hdfd/peer#example-package--NewOutboundPeer)  
