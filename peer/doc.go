...
function which allows a hdflog.Logger to be specified.  For example, logging at
...
(https://godoc.org/github.com/ifishnet/hdfd/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
