...
import (
	...
	peerpkg "github.com/ifishnet/hdfd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*hdfutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *hdfutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *hdfutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *hdfutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
