...
func (msg *MsgAddr) HdfDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if count > MaxAddrPerMsg {
		...
		return messageError("MsgAddr.HdfDecode", str)
	}
...
// This is part of the Message interface implementation.
func (msg *MsgAddr) HdfEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	...
	if pver < MultipleAddressVersion && count > 1 {
		...
		return messageError("MsgAddr.HdfEncode", str)
