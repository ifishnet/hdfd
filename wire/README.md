...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/ifishnet/hdfd/wire)
=======
...
[here](https://blog.conformal.com/hdfwire-the-bitcoin-wire-protocol-package-from-hdfd/).
...
```bash
$ go get -u github.com/ifishnet/hdfd/wire
```
...
```Go
	...
	// protocol version pver and the bitcoin network hdfnet.  The returns
	// are a wire.Message, a []byte which contains the unmarshalled
	// raw payload, and a possible error.
	msg, rawPayload, err := wire.ReadMessage(conn, pver, hdfnet)
	if err != nil {
...
```Go
	...
	// pver, and the bitcoin network hdfnet.  The return is a possible
	// error.
	err := wire.WriteMessage(conn, msg, pver, hdfnet)
	if err != nil {
		// Log and handle the error
	}
```
