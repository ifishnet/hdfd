// Copyright (c) 2018 The ifishnet developers
...
func (msg *MsgCFCheckpt) HdfDecode(r io.Reader, pver uint32, _ MessageEncoding) error {
	// Read filter type
...
// This is part of the Message interface implementation.
func (msg *MsgCFCheckpt) HdfEncode(w io.Writer, pver uint32, _ MessageEncoding) error {
	// Write filter type
