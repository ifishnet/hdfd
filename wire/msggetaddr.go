...
func (msg *MsgGetAddr) HdfDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	return nil
}

// HdfEncode encodes the receiver to w using the bitcoin protocol encoding.
// This is part of the Message interface implementation.
func (msg *MsgGetAddr) HdfEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
	return nil
}
