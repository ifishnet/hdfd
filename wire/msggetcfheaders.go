...
func (msg *MsgGetCFHeaders) HdfDecode(r io.Reader, pver uint32, _ MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgGetCFHeaders) HdfEncode(w io.Writer, pver uint32, _ MessageEncoding) error {
