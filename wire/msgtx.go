...
func (msg *MsgTx) HdfDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	...
	if count == 0 && enc == WitnessEncoding {
		...
		if flag[0] != 0x01 {
			...
			return messageError("MsgTx.HdfDecode", str)
		}
...
// the Version field in the transaction.  This function differs from HdfDecode
// in that HdfDecode decodes from the bitcoin wire protocol as it was sent
...
func (msg *MsgTx) HdfEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
...
// the transaction.  This function differs from HdfEncode in that HdfEncode
...
func (msg *MsgTx) Serialize(w io.Writer) error {
	...
	//
	// Passing a encoding type of WitnessEncoding to HdfEncode for MsgTx
