...
func (msg *MsgGetCFCheckpt) HdfDecode(r io.Reader, pver uint32, _ MessageEncoding) error {
...
// This is part of the Message interface implementation.
func (msg *MsgGetCFCheckpt) HdfEncode(w io.Writer, pver uint32, _ MessageEncoding) error {
