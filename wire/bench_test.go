...
func BenchmarkDecodeGetHeaders(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.HdfEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgGetHeaders.HdfEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
	...
	for i := 0; i < b.N; i++ {
		r.Seek(0, 0)
		msg.HdfDecode(r, pver, LatestEncoding)
	}
}
...
func BenchmarkDecodeHeaders(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.HdfEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgHeaders.HdfEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeGetBlocks(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.HdfEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgGetBlocks.HdfEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeAddr(b *testing.B) {
	...
	// Serialize it so the bytes are available to test the decode below.
	var bb bytes.Buffer
	if err := ma.HdfEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgAddr.HdfEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeInv(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.HdfEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgInv.HdfEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeNotFound(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.HdfEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgNotFound.HdfEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
...
func BenchmarkDecodeMerkleBlock(b *testing.B) {
	...
	var bb bytes.Buffer
	if err := m.HdfEncode(&bb, pver, LatestEncoding); err != nil {
		b.Fatalf("MsgMerkleBlock.HdfEncode: unexpected error: %v", err)
	}
	buf := bb.Bytes()
