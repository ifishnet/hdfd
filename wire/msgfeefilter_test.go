...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.HdfEncode(&buf, pver, BaseEncoding)
	if err != nil {
	...
	err = readmsg.HdfDecode(&buf, pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.HdfEncode(&buf, test.pver, BaseEncoding)
		if err != nil {
		...
		err = msg.HdfDecode(rbuf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.HdfEncode(w, test.pver, BaseEncoding)
		...
		err = msg.HdfDecode(r, test.pver, BaseEncoding)
