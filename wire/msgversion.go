...
const DefaultUserAgent = "/hdfwire:0.5.0/"
...
func (msg *MsgVersion) HdfDecode(r io.Reader, pver uint32, enc MessageEncoding) error {
	buf, ok := r.(*bytes.Buffer)
	if !ok {
		return fmt.Errorf("MsgVersion.HdfDecode reader is not a " +
			"*bytes.Buffer")
	}
...
// This is part of the Message interface implementation.
func (msg *MsgVersion) HdfEncode(w io.Writer, pver uint32, enc MessageEncoding) error {
