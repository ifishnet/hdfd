...
func TestFilterLoadCrossProtocol(t *testing.T) {
	...
	var buf bytes.Buffer
	err := msg.HdfEncode(&buf, ProtocolVersion, BaseEncoding)
	if err != nil {
	...
	err = readmsg.HdfDecode(&buf, BIP0031Version, BaseEncoding)
	if err == nil {
...
func TestFilterLoadMaxFilterSize(t *testing.T) {
	...
	err = msg.HdfDecode(readbuf, ProtocolVersion, BaseEncoding)
	if err == nil {
