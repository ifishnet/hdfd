...
func New(activeNet *chaincfg.Params, handlers *rpcclient.NotificationHandlers,
	...
	if handlers.OnFilteredBlockConnected != nil {
		...
		handlers.OnFilteredBlockConnected = func(height int32, header *wire.BlockHeader, filteredTxns []*hdfutil.Tx) {
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// wallet.
	filterAddrs := []hdfutil.Address{h.wallet.coinbaseAddr}
...
func (h *Harness) NewAddress() (hdfutil.Address, error) {
...
//
// This function is safe for concurrent access.
func (h *Harness) ConfirmedBalance() hdfutil.Amount {
...
//
// This function is safe for concurrent access.
func (h *Harness) GenerateAndSubmitBlock(txns []*hdfutil.Tx, blockVersion int32,
	blockTime time.Time) (*hdfutil.Block, error) {
...
func (h *Harness) GenerateAndSubmitBlockWithCustomCoinbaseOutputs(
	txns []*hdfutil.Tx, blockVersion int32, blockTime time.Time,
	mineTo []wire.TxOut) (*hdfutil.Block, error) {
	...
	prevBlock := hdfutil.NewBlock(mBlock)
...
func baseDir() (string, error) {
	dirPath := filepath.Join(os.TempDir(), "hdfd", "rpctest")
