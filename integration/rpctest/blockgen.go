...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr hdfutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*hdfutil.Tx, error) {
...
func CreateBlock(prevBlock *hdfutil.Block, inclusionTxs []*hdfutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr hdfutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*hdfutil.Block, error) {
	...
	blockTxns := []*hdfutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := hdfutil.NewBlock(&block)
