...
import (
	...
	ldberrors "github.com/ifishnet/goleveldb/leveldb/errors"
)
...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*hdfutil.Block, error) {
	...
	blocks := make([]*hdfutil.Block, 0, 256)
	genesis := hdfutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
