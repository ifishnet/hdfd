// Copyright (c) 2015-2017 The ifishnet developers
...
var helpDescsEnUS = map[string]string{
	...
	// NotifySpentCmd help.
	"notifyspent--synopsis": "Send a redeemingtx notification when a transaction spending an outpoint appears in mempool (if relayed to this hdfd instance) and when such a transaction first appears in a newly-attached block.",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"decoderawtransaction":  {(*hdfjson.TxRawDecodeResult)(nil)},
	"decodescript":          {(*hdfjson.DecodeScriptResult)(nil)},
	"estimatefee":           {(*float64)(nil)},
	"generate":              {(*[]string)(nil)},
	"getaddednodeinfo":      {(*[]string)(nil), (*[]hdfjson.GetAddedNodeInfoResult)(nil)},
	"getbestblock":          {(*hdfjson.GetBestBlockResult)(nil)},
	"getbestblockhash":      {(*string)(nil)},
	"getblock":              {(*string)(nil), (*hdfjson.GetBlockVerboseResult)(nil)},
	"getblockcount":         {(*int64)(nil)},
	"getblockhash":          {(*string)(nil)},
	"getblockheader":        {(*string)(nil), (*hdfjson.GetBlockHeaderVerboseResult)(nil)},
	"getblocktemplate":      {(*hdfjson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
	"getblockchaininfo":     {(*hdfjson.GetBlockChainInfoResult)(nil)},
	...
	"getinfo":               {(*hdfjson.InfoChainResult)(nil)},
	"getmempoolinfo":        {(*hdfjson.GetMempoolInfoResult)(nil)},
	"getmininginfo":         {(*hdfjson.GetMiningInfoResult)(nil)},
	"getnettotals":          {(*hdfjson.GetNetTotalsResult)(nil)},
	"getnetworkhashps":      {(*int64)(nil)},
	"getpeerinfo":           {(*[]hdfjson.GetPeerInfoResult)(nil)},
	"getrawmempool":         {(*[]string)(nil), (*hdfjson.GetRawMempoolVerboseResult)(nil)},
	"getrawtransaction":     {(*string)(nil), (*hdfjson.TxRawResult)(nil)},
	"gettxout":              {(*hdfjson.GetTxOutResult)(nil)},
	"node":                  nil,
	"help":                  {(*string)(nil), (*string)(nil)},
	"ping":                  nil,
	"searchrawtransactions": {(*string)(nil), (*[]hdfjson.SearchRawTransactionsResult)(nil)},
	"sendrawtransaction":    {(*string)(nil)},
	"setgenerate":           nil,
	"stop":                  {(*string)(nil)},
	"submitblock":           {nil, (*string)(nil)},
	"uptime":                {(*int64)(nil)},
	"validateaddress":       {(*hdfjson.ValidateAddressChainResult)(nil)},
	"verifychain":           {(*bool)(nil)},
	"verifymessage":         {(*bool)(nil)},
	"version":               {(*map[string]hdfjson.VersionResult)(nil)},

	// Websocket commands.
	"loadtxfilter":              nil,
	"session":                   {(*hdfjson.SessionResult)(nil)},
	"notifyblocks":              nil,
	...
	"stopnotifyspent":           nil,
	"rescan":                    nil,
	"rescanblocks":              {(*[]hdfjson.RescannedBlock)(nil)},
}
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := hdfjson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := hdfjson.MethodUsageText(k)
		if err != nil {
			return "", err
		}
