...
// hdfutil.Block.  This is largely borrowed from the test code in hdfdb.
func loadBlocks(filename string) (blocks []*hdfutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = hdfutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
