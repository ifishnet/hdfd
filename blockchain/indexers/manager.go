...
func dbIndexConnectBlock(dbTx database.Tx, indexer Indexer, block *hdfutil.Block,
...
func dbIndexDisconnectBlock(dbTx database.Tx, indexer Indexer, block *hdfutil.Block,
	stxo []blockchain.SpentTxOut) error {
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) ConnectBlock(dbTx database.Tx, block *hdfutil.Block,
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) DisconnectBlock(dbTx database.Tx, block *hdfutil.Block,
	stxo []blockchain.SpentTxOut) error {
