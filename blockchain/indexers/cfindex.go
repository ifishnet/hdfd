...
import (
	...
	"github.com/ifishnet/hdfutil/gcs/builder"
)
...
func storeFilter(dbTx database.Tx, block *hdfutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *hdfutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *hdfutil.Block,
