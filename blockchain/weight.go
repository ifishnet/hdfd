...
func GetBlockWeight(blk *hdfutil.Block) int64 {
...
func GetTransactionWeight(tx *hdfutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *hdfutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
