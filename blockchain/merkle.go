...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*hdfutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *hdfutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *hdfutil.Block) error {
