// Copyright (c) 2015-2016 The ifishnet developers
...
func (view *UtxoViewpoint) AddTxOut(tx *hdfutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *hdfutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *hdfutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *hdfutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *hdfutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *hdfutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *hdfutil.Tx) (*UtxoViewpoint, error) {
