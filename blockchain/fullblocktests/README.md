...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/ifishnet/hdfd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/ifishnet/hdfd/blockchain/fullblocktests
```
