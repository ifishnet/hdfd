...
type config struct {
	...
	UseGoOutput    bool   `short:"g" long:"gooutput" description:"Display the candidates using Go syntax that is ready to insert into the hdfchain checkpoint list"`
...
// time of writing, hdfd currently places blocks for testnet version 3 in the
